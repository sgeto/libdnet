 ...
 *
 * $Id: arp.c 352 2002-05-08 04:55:32Z dugsong $
 */
...
arp_usage(void)
{
	fprintf(stderr, "Usage: dumbnet arp [op|sha|spa|tha|tpa <value>] ...\n"
	                "       dumbnet arp show\n"
	                "       dumbnet arp get <host>\n"
	                "       dumbnet arp add <host> <mac>\n"
	                "       dumbnet arp delete <host>\n");
	exit(1);
}
